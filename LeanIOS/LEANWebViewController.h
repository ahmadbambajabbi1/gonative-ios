...
- (void)switchToWebView:(UIView *)webView showImmediately:(BOOL)showImmediately;
- (void)updateStatusBarBackgroundColor:(UIColor *)color enableBlurEffect:(BOOL)enableBlurEffect;
- (void)hideWebview;
- (void)showWebview;
- (void)setNativeTheme:(NSInteger)mode iosDarkMode:(BOOL)darkMode;
- (NSDictionary *)getConnectivity;
- (void)runKeyboardInfoWithCallback:(id)callback;
